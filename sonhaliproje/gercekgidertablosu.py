...
from gercekgidertablosu_python import Ui_MainWindow

class GiderTablosuPage(QMainWindow):
    def __init__(self) -> None:
        super().__init__()
        self.gidtabyapform = Ui_MainWindow()
        self.gidtabyapform.setupUi(self)
